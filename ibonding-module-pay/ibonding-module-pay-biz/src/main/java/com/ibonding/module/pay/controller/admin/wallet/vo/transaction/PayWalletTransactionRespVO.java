package com.ibonding.module.pay.controller.admin.wallet.vo.transaction;
...
public class PayWalletTransactionRespVO {
    ...
    // TODO @Agaru：merchantOrderId 字段，需要在 PayWalletTransaction 存储下；然后，前端也返回下这个字段，界面也展示下商户名
