package com.ibonding.module.pay.convert.order;
...
import com.ibonding.module.pay.controller.admin.order.vo.*;
...
public interface PayOrderConvert {
    ...
    PayOrderSubmitRespVO convert(PayOrderDO order, com.ibonding.framework.pay.core.client.dto.order.PayOrderRespDTO respDTO);
