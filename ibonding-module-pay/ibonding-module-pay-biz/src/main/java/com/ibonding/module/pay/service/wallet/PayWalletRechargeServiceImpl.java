package com.ibonding.module.pay.service.wallet;
...
import com.ibonding.framework.pay.core.enums.refund.PayRefundStatusRespEnum;
import com.ibonding.module.pay.api.order.dto.PayOrderCreateReqDTO;
import com.ibonding.module.pay.api.refund.dto.PayRefundCreateReqDTO;
...
import com.ibonding.module.pay.dal.mysql.wallet.PayWalletRechargeMapper;
...
import static com.ibonding.framework.common.util.date.LocalDateTimeUtils.addTime;
import static com.ibonding.framework.common.util.json.JsonUtils.toJsonString;
import static com.ibonding.framework.common.util.number.MoneyUtils.fenToYuanStr;
import static com.ibonding.module.pay.convert.wallet.PayWalletRechargeConvert.INSTANCE;
import static com.ibonding.module.pay.enums.ErrorCodeConstants.*;
import static com.ibonding.module.pay.enums.MessageTemplateConstants.WXA_WALLET_RECHARGER_PAID;
import static com.ibonding.module.pay.enums.refund.PayRefundStatusEnum.*;
...
public class PayWalletRechargeServiceImpl implements PayWalletRechargeService {
    ...
    public PayWalletRechargeDO createWalletRecharge(Long userId, Integer userType, String userIp,
        ...
        Long payOrderId = payOrderService.createOrder(new PayOrderCreateReqDTO()
                ...
                .setExpireTime(addTime(Duration.ofHours(2L)))); // TODO @Agaru：支付超时时间
        // 2.2 更新钱包充值记录中支付订单
    ...
    public void updateWalletRechargerPaid(Long id, Long payOrderId) {
        ...
        // 4. 更新钱包余额
        // TODO @Agaru：这样的话，未来提现会不会把充值的，也提现走哈。类似先充 100，送 110；然后提现 110；
        // TODO 需要钱包中加个可提现余额
    ...
    private PayWalletDO validateWalletRechargeCanRefund(PayWalletRechargeDO walletRecharge) {
        ...
        // TODO @Agaru：需要考虑下，赠送的金额，会不会导致提现超过；
        return wallet;
    }
