package com.ibonding.module.infra.service.logger;
...
import com.ibonding.module.infra.dal.mysql.logger.ApiErrorLogMapper;
import com.ibonding.module.infra.enums.logger.ApiErrorLogProcessStatusEnum;
...
import static com.ibonding.module.infra.enums.ErrorCodeConstants.API_ERROR_LOG_NOT_FOUND;
import static com.ibonding.module.infra.enums.ErrorCodeConstants.API_ERROR_LOG_PROCESSED;
...
public class ApiErrorLogServiceImplTest extends BaseDbUnitTest {
    ...
    public void testGetApiErrorLogPage() {
        ...
        ApiErrorLogDO apiErrorLogDO = randomPojo(ApiErrorLogDO.class, o -> {
            ...
            o.setApplicationName("ibonding-test");
            o.setRequestUrl("foo");
        ...
        reqVO.setApplicationName("ibonding-test");
    ...
    public void testCleanJobLog() {
        ...
        // TODO @Agaru：createTime updateTime 被屏蔽，仅 win11 会复现，建议后续修复。
