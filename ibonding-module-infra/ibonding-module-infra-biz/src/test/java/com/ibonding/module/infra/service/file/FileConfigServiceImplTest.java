package com.ibonding.module.infra.service.file;

import cn.hutool.core.date.DatePattern;
import cn.hutool.core.date.LocalDateTimeUtil;
import cn.hutool.core.map.MapUtil;
import com.ibonding.framework.common.pojo.PageResult;
import com.ibonding.module.infra.framework.file.core.client.FileClient;
import com.ibonding.module.infra.framework.file.core.client.FileClientConfig;
import com.ibonding.module.infra.framework.file.core.client.FileClientFactory;
import com.ibonding.module.infra.framework.file.core.client.local.LocalFileClient;
import com.ibonding.module.infra.framework.file.core.client.local.LocalFileClientConfig;
import com.ibonding.module.infra.framework.file.core.enums.FileStorageEnum;
...
import com.ibonding.module.infra.dal.mysql.file.FileConfigMapper;
import lombok.Data;
...
import static com.ibonding.framework.test.core.util.RandomUtils.randomLongId;
import static com.ibonding.framework.test.core.util.RandomUtils.randomPojo;
import static com.ibonding.module.infra.enums.ErrorCodeConstants.FILE_CONFIG_DELETE_FAIL_MASTER;
import static com.ibonding.module.infra.enums.ErrorCodeConstants.FILE_CONFIG_NOT_EXISTS;
...
public class FileConfigServiceImplTest extends BaseDbUnitTest {
    ...
    public void testCreateFileConfig_success() {
        // 准备参数
        Map<String, Object> config = MapUtil.<String, Object>builder().put("basePath", "/ibonding")
        ...
        assertEquals("/ibonding", ((LocalFileClientConfig) fileConfig.getConfig()).getBasePath());
    ...
    public void testUpdateFileConfig_success() {
        ...
        FileConfigDO dbFileConfig = randomPojo(FileConfigDO.class, o -> o.setStorage(FileStorageEnum.LOCAL.getStorage())
                .setConfig(new LocalFileClientConfig().setBasePath("/ibonding").setDomain("https://www.iocoder.cn")));
        ...
        FileConfigSaveReqVO reqVO = randomPojo(FileConfigSaveReqVO.class, o -> {
            ...
            Map<String, Object> config = MapUtil.<String, Object>builder().put("basePath", "/ibonding2")
        ...
        assertEquals("/ibonding2", ((LocalFileClientConfig) fileConfig.getConfig()).getBasePath());
    ...
    public void testGetFileConfigPage() {
        // mock 数据
        FileConfigDO dbFileConfig = randomFileConfigDO().setName("Agaru")
        ...
        // 测试 name 不匹配
        fileConfigMapper.insert(cloneIgnoreId(dbFileConfig, o -> o.setName("Agaru")));
        // 测试 storage 不匹配
