package com.ibonding.module.infra.framework.file.core.s3;
...
public class S3FileClientTest {
    ...
    public void testMinIO() throws Exception {
        ...
        config.setBucket("ibondingyuanma");
    ...
    public void testAliyun() throws Exception {
        ...
        config.setBucket("ibonding-aoteman");
...
//        config.setAccessSecret(System.getenv("QINIU_SECRET_KEY"));
        ...
        config.setDomain("http://test.ibonding.iocoder.cn"); // 如果有自定义域名，则可以设置。http://static.ibonding.iocoder.cn
        // 默认上海的 endpoint
