package com.ibonding.module.infra.service.db;

import cn.hutool.core.map.MapUtil;
import cn.hutool.core.util.ReflectUtil;
import cn.hutool.crypto.symmetric.AES;
import com.ibonding.framework.mybatis.core.type.EncryptTypeHandler;
import com.ibonding.framework.mybatis.core.util.JdbcUtils;
...
import com.ibonding.module.infra.dal.mysql.db.DataSourceConfigMapper;
...
import static com.ibonding.module.infra.enums.ErrorCodeConstants.DATA_SOURCE_CONFIG_NOT_EXISTS;
...
public class DataSourceConfigServiceImplTest extends BaseDbUnitTest {
    ...
    public void setUp() {
        ...
        dataSourceProperty.setUsername("ibonding");
    ...
    public void testGetDataSourceConfig_master() {
        ...
        assertEquals("ibonding", dataSourceConfig.getUsername());
    ...
    public void testGetDataSourceConfigList() {
        ...
        assertEquals("ibonding", dataSourceConfigList.get(0).getUsername());
