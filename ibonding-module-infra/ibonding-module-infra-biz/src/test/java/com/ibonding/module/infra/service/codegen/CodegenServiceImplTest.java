package com.ibonding.module.infra.service.codegen;
...
import com.ibonding.module.infra.controller.admin.codegen.vo.column.CodegenColumnSaveReqVO;
...
import com.ibonding.module.infra.dal.mysql.codegen.CodegenColumnMapper;
import com.ibonding.module.infra.dal.mysql.codegen.CodegenTableMapper;
import com.ibonding.module.infra.enums.codegen.CodegenFrontTypeEnum;
import com.ibonding.module.infra.enums.codegen.CodegenSceneEnum;
import com.ibonding.module.infra.enums.codegen.CodegenTemplateTypeEnum;
import com.ibonding.module.infra.framework.codegen.config.CodegenProperties;
import com.ibonding.module.infra.service.codegen.inner.CodegenBuilder;
import com.ibonding.module.infra.service.codegen.inner.CodegenEngine;
import com.ibonding.module.infra.service.db.DatabaseTableService;
import com.ibonding.module.system.api.user.AdminUserApi;
...
import static com.ibonding.framework.common.util.date.LocalDateTimeUtils.buildBetweenTime;
import static com.ibonding.framework.common.util.date.LocalDateTimeUtils.buildTime;
import static com.ibonding.framework.common.util.object.ObjectUtils.cloneIgnoreId;
...
public class CodegenServiceImplTest extends BaseDbUnitTest {
    ...
    public void testCreateCodegenList() {
        ...
        CodegenCreateListReqVO reqVO = randomPojo(CodegenCreateListReqVO.class,
                o -> o.setDataSourceConfigId(1L).setTableNames(Collections.singletonList("t_ibonding")));
        // mock 方法（TableInfo）
        TableInfo tableInfo = mock(TableInfo.class);
        when(databaseTableService.getTable(eq(1L), eq("t_ibonding")))
                .thenReturn(tableInfo);
        when(tableInfo.getComment()).thenReturn("Agaru");
    ...
    public void testSyncCodegenFromDB() {
        ...
        CodegenTableDO table = randomPojo(CodegenTableDO.class, o -> o.setTableName("t_ibonding")
    ...
    public void testGetCodegenTablePage() {
        ...
        CodegenTableDO tableDO = randomPojo(CodegenTableDO.class, o -> {
            o.setTableName("t_ibonding");
            o.setTableComment("Agaru");
            o.setClassName("SystemIbonding");
        ...
        reqVO.setTableName("ibonding");
        reqVO.setTableComment("芋");
        reqVO.setClassName("ibonding");
    ...
    public void testGetDatabaseTableList() {
        ...
        when(tableInfo01.getName()).thenReturn("t_ibonding");
        when(tableInfo01.getComment()).thenReturn("Agaru");
        TableInfo tableInfo02 = mock(TableInfo.class);
        when(tableInfo02.getName()).thenReturn("t_ibonding_02");
        when(tableInfo02.getComment()).thenReturn("Agaru_02");
        ...
        // 断言
        assertEquals(1, result.size());
        assertEquals("t_ibonding", result.get(0).getName());
        assertEquals("Agaru", result.get(0).getComment());
    }
