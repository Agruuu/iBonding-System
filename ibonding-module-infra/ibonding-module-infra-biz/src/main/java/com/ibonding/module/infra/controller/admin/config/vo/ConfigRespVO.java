package com.ibonding.module.infra.controller.admin.config.vo;
...
import com.ibonding.module.infra.enums.DictTypeConstants;
...
public class ConfigRespVO {
    ...
    @Schema(description = "参数键名", requiredMode = Schema.RequiredMode.REQUIRED, example = "ibonding.db.username")
    @ExcelProperty("参数键名")
    private String key;
