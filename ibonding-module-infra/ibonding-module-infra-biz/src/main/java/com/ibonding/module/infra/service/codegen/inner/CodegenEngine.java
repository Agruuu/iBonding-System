package com.ibonding.module.infra.service.codegen.inner;
...
import com.ibonding.framework.apilog.core.enums.OperateTypeEnum;
...
import com.ibonding.framework.common.util.string.StrUtils;
import com.ibonding.framework.excel.core.annotations.DictFormat;
import com.ibonding.framework.excel.core.convert.DictConvert;
...
public class CodegenEngine {
    ...
    private static String javaModuleFilePath(String path, String module, String src) {
        return "ibonding-module-${table.moduleName}/" + // 顶级模块
                "ibonding-module-${table.moduleName}-" + module + "/" + // 子模块
                "src/" + src + "/java/${basePackage}/module/${table.moduleName}/" + path + ".java";
    }

    private static String mapperXmlFilePath() {
        return "ibonding-module-${table.moduleName}/" + // 顶级模块
                "ibonding-module-${table.moduleName}-biz/" + // 子模块
    ...
    private static String vueFilePath(String path) {
        return "ibonding-ui-${sceneEnum.basePackage}-vue2/" + // 顶级目录
                "src/" + path;
    }
    ...
    private static String vue3FilePath(String path) {
        return "ibonding-ui-${sceneEnum.basePackage}-vue3/" + // 顶级目录
                "src/" + path;
    }
