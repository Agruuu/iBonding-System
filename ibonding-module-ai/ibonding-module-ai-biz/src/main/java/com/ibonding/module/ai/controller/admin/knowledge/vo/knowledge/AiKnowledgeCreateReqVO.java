package com.ibonding.module.ai.controller.admin.knowledge.vo.knowledge;
...
public class AiKnowledgeCreateReqVO {
    ...
    @Schema(description = "知识库名称", requiredMode = Schema.RequiredMode.REQUIRED, example = "iBonding-System 用户指南")
    @NotBlank(message = "知识库名称不能为空")
    private String name;

    @Schema(description = "知识库描述", requiredMode = Schema.RequiredMode.REQUIRED, example = "存储 iBonding-System 操作文档")
