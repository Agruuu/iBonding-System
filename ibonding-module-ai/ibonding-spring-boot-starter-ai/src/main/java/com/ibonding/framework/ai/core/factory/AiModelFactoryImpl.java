package com.ibonding.framework.ai.core.factory;
...
import com.ibonding.framework.ai.config.IbondingAiAutoConfiguration;
import com.ibonding.framework.ai.config.IbondingAiProperties;
...
import com.ibonding.framework.common.util.spring.SpringUtils;
...
public class AiModelFactoryImpl implements AiModelFactory {
    ...
    public MidjourneyApi getOrCreateMidjourneyApi(String apiKey, String url) {
        ...
        return Singleton.get(cacheKey, (Func0<MidjourneyApi>) () -> {
            IbondingAiProperties.MidjourneyProperties properties = SpringUtil.getBean(IbondingAiProperties.class)
                    .getMidjourney();
    ...
    /**
     * 可参考 {@link IbondingAiAutoConfiguration#deepSeekChatModel(IbondingAiProperties)}
     */
    private static DeepSeekChatModel buildDeepSeekChatModel(String apiKey) {
        IbondingAiProperties.DeepSeekProperties properties = new IbondingAiProperties.DeepSeekProperties()
                .setApiKey(apiKey);
        return new IbondingAiAutoConfiguration().buildDeepSeekChatModel(properties);
    }

    /**
     * 可参考 {@link IbondingAiAutoConfiguration#douBaoChatClient(IbondingAiProperties)}
     */
    private ChatModel buildDouBaoChatModel(String apiKey) {
        IbondingAiProperties.DouBaoProperties properties = new IbondingAiProperties.DouBaoProperties()
                .setApiKey(apiKey);
        return new IbondingAiAutoConfiguration().buildDouBaoChatClient(properties);
    }

    /**
     * 可参考 {@link IbondingAiAutoConfiguration#hunYuanChatClient(IbondingAiProperties)}
     */
    private ChatModel buildHunYuanChatModel(String apiKey, String url) {
        IbondingAiProperties.HunYuanProperties properties = new IbondingAiProperties.HunYuanProperties()
                .setBaseUrl(url).setApiKey(apiKey);
        return new IbondingAiAutoConfiguration().buildHunYuanChatClient(properties);
    }

    /**
     * 可参考 {@link IbondingAiAutoConfiguration#siliconFlowChatClient(IbondingAiProperties)}
     */
    private ChatModel buildSiliconFlowChatModel(String apiKey) {
        IbondingAiProperties.SiliconFlowProperties properties = new IbondingAiProperties.SiliconFlowProperties()
                .setApiKey(apiKey);
        return new IbondingAiAutoConfiguration().buildSiliconFlowChatClient(properties);
    }
    ...
    /**
     * 可参考 {@link IbondingAiAutoConfiguration#xingHuoChatClient(IbondingAiProperties)}
     */
    private static XingHuoChatModel buildXingHuoChatModel(String key) {
        ...
        IbondingAiProperties.XingHuoProperties properties = new IbondingAiProperties.XingHuoProperties()
                .setAppKey(keys.get(0)).setSecretKey(keys.get(1));
        return new IbondingAiAutoConfiguration().buildXingHuoChatClient(properties);
    }
