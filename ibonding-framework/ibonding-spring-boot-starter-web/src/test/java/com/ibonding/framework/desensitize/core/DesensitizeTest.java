package com.ibonding.framework.desensitize.core;

import com.ibonding.framework.common.util.json.JsonUtils;
import com.ibonding.framework.desensitize.core.annotation.Address;
import com.ibonding.framework.desensitize.core.regex.annotation.EmailDesensitize;
import com.ibonding.framework.desensitize.core.regex.annotation.RegexDesensitize;
import com.ibonding.framework.desensitize.core.slider.annotation.*;
import lombok.Data;
...
public class DesensitizeTest {
    ...
    public void test() {
        ...
        desensitizeDemo.setNickname("Agaru");
        ...
        desensitizeDemo.setRegex("你好，我是Agaru");
        desensitizeDemo.setAddress("北京市海淀区上地十街10号");
        desensitizeDemo.setOrigin("Agaru");
        ...
        assertEquals("Agaru", d.getOrigin());
    }
    ...
    public static class DesensitizeDemo {
        ...
        @RegexDesensitize(regex = "Agaru", replacer = "*")
