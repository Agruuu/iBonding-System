package com.ibonding.framework.swagger.config;
...
import static com.ibonding.framework.web.core.util.WebFrameworkUtils.HEADER_TENANT_ID;
...
public class IbondingSwaggerAutoConfiguration {
