package com.ibonding.framework.websocket.core.sender.rocketmq;
...
@RocketMQMessageListener( // 重点：添加 @RocketMQMessageListener 注解，声明消费的 topic
        topic = "${ibonding.websocket.sender-rocketmq.topic}",
        consumerGroup = "${ibonding.websocket.sender-rocketmq.consumer-group}",
