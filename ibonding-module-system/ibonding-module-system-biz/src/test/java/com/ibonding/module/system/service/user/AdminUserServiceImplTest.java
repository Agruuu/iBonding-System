package com.ibonding.module.system.service.user;
...
import com.ibonding.module.infra.api.config.ConfigApi;
import com.ibonding.module.infra.api.file.FileApi;
...
import com.ibonding.module.system.dal.dataobject.dept.UserPostDO;
import com.ibonding.module.system.dal.dataobject.user.AdminUserDO;
import com.ibonding.module.system.dal.mysql.dept.UserPostMapper;
import com.ibonding.module.system.dal.mysql.user.AdminUserMapper;
...
import static com.ibonding.framework.common.util.collection.SetUtils.asSet;
...
import static com.ibonding.module.system.enums.ErrorCodeConstants.*;
import static com.ibonding.module.system.service.user.AdminUserServiceImpl.USER_INIT_PASSWORD_KEY;
...
public class AdminUserServiceImplTest extends BaseDbUnitTest {
    ...
    public void before() {
        // mock 初始化密码
        when(configApi.getConfigValueByKey(USER_INIT_PASSWORD_KEY)).thenReturn("ibondingyuanma");
    }
    ...
    public void testCreatUser_success() {
        ...
        when(passwordEncoder.encode(eq(reqVO.getPassword()))).thenReturn("ibondingyuanma");
        ...
        assertEquals("ibondingyuanma", user.getPassword());
    ...
    public void testImportUserList_02() {
        ...
        when(deptService.getDept(eq(dept.getId()))).thenReturn(dept);
        // mock passwordEncoder 的方法
        when(passwordEncoder.encode(eq("ibondingyuanma"))).thenReturn("java");
    ...
    public void testGetUserListByNickname() {
        ...
        userMapper.insert(user);
        // 测试 nickname 不匹配
        userMapper.insert(randomAdminUserDO(o -> o.setNickname("Agaru")));
        // 准备参数
        String nickname = "芋";
