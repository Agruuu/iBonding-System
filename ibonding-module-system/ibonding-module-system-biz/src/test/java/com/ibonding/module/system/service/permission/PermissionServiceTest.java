...
import com.ibonding.module.system.api.permission.dto.DeptDataPermissionRespDTO;
...
import com.ibonding.module.system.dal.dataobject.permission.RoleMenuDO;
import com.ibonding.module.system.dal.dataobject.permission.UserRoleDO;
import com.ibonding.module.system.dal.dataobject.user.AdminUserDO;
import com.ibonding.module.system.dal.mysql.permission.RoleMenuMapper;
import com.ibonding.module.system.dal.mysql.permission.UserRoleMapper;
...
public class PermissionServiceTest extends BaseDbUnitTest {
    ...
    public void testHasAnyRoles() {
        try (MockedStatic<SpringUtil> springUtilMockedStatic = mockStatic(SpringUtil.class)) {
            ...
            // 准备参数
            Long userId = 1L;
            String[] roles = new String[]{"ibonding", "tudou"};
            // mock 用户与角色的缓存
            userRoleMapper.insert(randomPojo(UserRoleDO.class).setUserId(userId).setRoleId(100L));
