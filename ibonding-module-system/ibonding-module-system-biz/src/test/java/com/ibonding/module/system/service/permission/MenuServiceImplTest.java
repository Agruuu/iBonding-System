...
import com.ibonding.module.system.dal.mysql.permission.MenuMapper;
import com.ibonding.module.system.enums.permission.MenuTypeEnum;
...
import static com.ibonding.module.system.dal.dataobject.permission.MenuDO.ID_ROOT;
...
public class MenuServiceImplTest extends BaseDbUnitTest {
    ...
    public void testGetMenuList() {
        // mock 数据
        MenuDO menuDO = randomPojo(MenuDO.class, o -> o.setName("Agaru").setStatus(CommonStatusEnum.ENABLE.getStatus()));
        menuMapper.insert(menuDO);
        // 测试 status 不匹配
