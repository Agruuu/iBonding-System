...
import com.ibonding.framework.common.util.cache.CacheUtils;
...
import com.ibonding.module.system.dal.mysql.social.SocialClientMapper;
...
import static com.ibonding.framework.common.util.collection.MapUtils.findAndThen;
...
public class SocialClientServiceImpl implements SocialClientService {
     ...
     * 3. developer：开发版
     */
    @Value("${ibonding.wxa-code.env-version:release}")
     ...
     * 3. formal：正式版
     */
    @Value("${ibonding.wxa-subscribe-message.miniprogram-state:formal}")
