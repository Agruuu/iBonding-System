...
import com.ibonding.module.system.dal.dataobject.sms.SmsCodeDO;
import com.ibonding.module.system.dal.mysql.sms.SmsCodeMapper;
import com.ibonding.module.system.enums.sms.SmsSceneEnum;
import com.ibonding.module.system.framework.sms.config.SmsCodeProperties;
...
import static com.ibonding.framework.common.util.date.DateUtils.isToday;
...
public class SmsCodeServiceImpl implements SmsCodeService {
    ...
    private String createSmsCode(String mobile, Integer scene, String ip) {
        ...
        if (lastSmsCode != null) {
            ...
            // TODO Agaru：提升，每个 IP 每天可发送数量
            // TODO Agaru：提升，每个 IP 每小时可发送数量
        }
