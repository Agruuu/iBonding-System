...
import com.ibonding.module.member.controller.app.user.vo.AppMemberUserUpdateMobileReqVO;
...
import com.ibonding.module.member.service.auth.MemberAuthServiceImpl;
 ...
 */
@Disabled
@Import({MemberUserServiceImpl.class, IbondingRedisAutoConfiguration.class})
