package com.ibonding.module.member.controller.app.user.vo;
...
public class AppMemberUserInfoRespVO {
    ...
    public static class Level {
        ...
        @Schema(description = "等级名称", requiredMode = Schema.RequiredMode.REQUIRED, example = "Agaru")
        private String name;

        @Schema(description = "等级", requiredMode = Schema.RequiredMode.REQUIRED, example = "1")
        private Integer level;

        @Schema(description = "等级图标", example = "https://www.iocoder.cn/ibonding.jpg")
        private String icon;
