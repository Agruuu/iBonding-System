...
import com.ibonding.framework.common.enums.TerminalEnum;
...
import com.ibonding.module.system.api.oauth2.dto.OAuth2AccessTokenCreateReqDTO;
import com.ibonding.module.system.api.oauth2.dto.OAuth2AccessTokenRespDTO;
...
import com.ibonding.module.system.api.social.dto.SocialWxPhoneNumberInfoRespDTO;
import com.ibonding.module.system.enums.logger.LoginLogTypeEnum;
import com.ibonding.module.system.enums.logger.LoginResultEnum;
import com.ibonding.module.system.enums.oauth2.OAuth2ClientConstants;
...
import static com.ibonding.framework.web.core.util.WebFrameworkUtils.getTerminal;
import static com.ibonding.module.member.enums.ErrorCodeConstants.*;
...
public class MemberAuthServiceImpl implements MemberAuthService {
    ...
    public void sendSmsCode(Long userId, AppAuthSmsSendReqVO reqVO) {
        ...
        if (Objects.equals(reqVO.getScene(), SmsSceneEnum.MEMBER_UPDATE_PASSWORD.getScene())) {
            ...
            // TODO Agaru：后续 member user 手机非强绑定，这块需要做下调整；
