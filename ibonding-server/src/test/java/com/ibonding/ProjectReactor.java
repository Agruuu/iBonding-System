...
public class ProjectReactor {
    ...
    private static final String GROUP_ID = "com.ibonding";
    private static final String ARTIFACT_ID = "ibonding";
    private static final String PACKAGE_NAME = "com.ibonding";
    private static final String TITLE = "iBonding Management System";
    ...
    public static void main(String[] args) {
        ...
        // ========== 配置，需要你手动修改 ==========
        String groupIdNew = "com.ibonding";
        String artifactIdNew = "ibonding";
